import{d as _,b as o,g as l,u as c,f as j,n as k,o as p}from"./vue.esm-bundler-YEuhxn0F.js";const T={class:"overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm"},$={key:0,class:"border-b border-gray-200 px-6 py-4"},D={key:1,class:"border-t border-gray-200 px-6 py-4"},e=_({__name:"Card",props:{padding:{type:Boolean,default:!0}},setup(d){return(t,N)=>(p(),o("div",T,[t.$slots.header?(p(),o("div",$,[l(t.$slots,"header")])):c("",!0),j("div",{class:k(d.padding?"px-6 py-4":"")},[l(t.$slots,"default")],2),t.$slots.footer?(p(),o("div",D,[l(t.$slots,"footer")])):c("",!0)]))}});e.__docgenInfo={exportName:"default",displayName:"Card",description:"",tags:{},props:[{name:"padding",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}}],slots:[{name:"header"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/design-system-vuejs/design-system-vuejs/src/components/ui/card/Card.vue"]};const A={title:"Data Display/Card",component:e,tags:["autodocs"],argTypes:{padding:{control:"boolean"}}},a={render:()=>({components:{Card:e},template:`
      <Card>
    ...
    `})};var m,i,g;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => ({
    components: {
      Card
    },
...
}`,...(w=(v=n.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};const B=["Default","WithHeader","WithHeaderAndFooter","NoPadding"];export{a as Default,n as NoPadding,s as WithHeader,r as WithHeaderAndFooter,B as __namedExportsOrder,A as default};
